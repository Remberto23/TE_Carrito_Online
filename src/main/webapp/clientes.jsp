...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Clientes</h1>
            <a href="ClienteControlador?action=add" class="btn btn-primary btm-sm"><img src="https://img.icons8.com/ultraviolet/40/000000/plus.png"/>  Nuevo Cliente</a>
            <br><br>
            <div class="row">
                <table class="table table-dark table-hover">
                    ...
                    <c:forEach var="item" items="${clientes}">
                        <tr>
                            ...
                            <td>${item.email}</td>
                            <td>${item.password}</td>
                            <td><a id="deleteItem" href="ClienteControlador?action=delete&id=${item.idCliente}" class="btn" onclick="return(confirm('Esta seguro???'))"><img src="https://img.icons8.com/external-kiranshastry-gradient-kiranshastry/64/000000/external-delete-multimedia-kiranshastry-gradient-kiranshastry.png"/></a></td>
                            <td><a href="ClienteControlador?action=edit&id=${item.idCliente}" class="btn" ><img src="https://img.icons8.com/external-kiranshastry-gradient-kiranshastry/64/000000/external-edit-interface-kiranshastry-gradient-kiranshastry-1.png"/></a></td>
                        </tr>
                    </c:forEach>
